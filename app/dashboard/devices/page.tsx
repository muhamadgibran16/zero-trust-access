			...
			<div className="flex items-center justify-between mb-8">
				<div>
					<h1 className="text-2xl font-bold text-white flex items-center">
						<MonitorCheck className="w-5 h-5 mr-3 text-cyan-500" />
						Device Posture (MDM)
					</h1>
			...
			<div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
				...
				<div className="xl:col-span-1">
					<form
						...
						className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-2xl relative overflow-hidden">
						...
						<div className="space-y-4 relative z-10">
							<div>
								...
								<input
									...
									className="w-full bg-slate-800 border border-slate-700 rounded-lg text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500 font-mono"
								/>
							</div>
							...
							<div>
								...
								<input
									...
									className="w-full bg-slate-800 border border-slate-700 rounded-lg text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500"
								/>
							</div>
						...
						<div className="p-4 border-b border-slate-800 flex items-center justify-between">
							<div className="flex items-center w-full max-w-md">
								...
								<input
									...
									className="bg-transparent border-none text-slate-300 focus:outline-none w-full text-sm"
									disabled
								/>
							</div>
							...
							<tbody className="divide-y divide-slate-800/50">
								{loading ? (
									...
									devices.map((device) => (
										<tr
											key={device.id}
											className={`hover:bg-slate-800/30 transition-colors ${!device.isApproved ? "opacity-75 bg-slate-800/10" : ""}`}>
