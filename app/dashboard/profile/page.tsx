		...
		<div className="max-w-4xl mx-auto text-slate-900">
			<div className="mb-8">
				<h1 className="text-2xl font-bold text-slate-900 flex items-center">
					<User className="w-5 h-5 mr-3 text-violet-600" />
					My Profile
				</h1>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
				{/* Account Info */}
				<div className="bg-white border border-slate-200 rounded-xl p-6 shadow-lg flex flex-col">
					...
					<form
						...
						<div className="flex space-x-2">
							<input
								...
								className="flex-1 bg-slate-50 border border-slate-300 rounded-lg text-slate-900 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500"
								required
								minLength={2}
							/>
							<button
					...
					<form onSubmit={handleChangePassword} className="space-y-4">
						<div>
							...
							<div className="relative">
								<input
									...
									className="w-full bg-slate-50 border border-slate-300 rounded-lg text-slate-900 px-3 py-2 text-sm pr-10 focus:outline-none focus:ring-2 focus:ring-violet-500"
									required
								/>
								<button
									type="button"
						...
						<div>
							...
							<input
								...
								className="w-full bg-slate-50 border border-slate-300 rounded-lg text-slate-900 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500"
								required
								minLength={6}
							/>
						</div>
			...
			{/* My Devices */}
			<div className="mt-6 bg-white border border-slate-200 rounded-xl overflow-hidden shadow-lg">
				<div className="p-4 border-b border-slate-200 flex items-center">
					<HardDrive className="w-5 h-5 text-cyan-600 mr-3" />
