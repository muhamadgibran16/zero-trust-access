			...
			<div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-lg">
				<div className="p-4 border-b border-slate-200 flex items-center">
					...
					<input
						...
						className="bg-transparent border-none text-slate-900 focus:outline-none w-full placeholder:text-slate-400"
						disabled
					/>
				</div>
								...
								<tr
									...
									<td className="px-6 py-4 flex items-center justify-end space-x-3">
										<select
											...
											className="bg-slate-50 border border-slate-300 text-slate-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-24 p-2 disabled:opacity-50">
