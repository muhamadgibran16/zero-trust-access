							...
							{routes.length === 0 ? (
								...
								routes.map((route) => (
									<tr
										...
										<td className="px-6 py-4">
											<span className="inline-flex items-center px-2 py-1 bg-slate-100 border border-slate-300 rounded text-sm text-slate-700 font-mono">
												{route.pathPrefix}
											</span>
										</td>
										...
										<td className="px-6 py-4 text-right">
											<button
												...
												className="p-2 bg-slate-100 text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors mr-2"
												title="Edit Route">
						...
						<form onSubmit={handleSubmit} className="p-6 space-y-4">
							...
							<div>
								...
								<input
									...
									className="w-full bg-slate-50 border border-slate-300 rounded-lg px-4 py-2 text-slate-900 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
							...
							<div>
								...
								<input
									...
									className="w-full bg-slate-50 border border-slate-300 rounded-lg px-4 py-2 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
							...
							<div className="grid grid-cols-2 gap-4">
								<div>
									...
									<input
										...
										className="w-full bg-slate-50 border border-slate-300 rounded-lg px-4 py-2 text-slate-900 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 font-mono text-sm"
										placeholder="/hr-app"
									/>
								...
								<div>
									...
									<input
										...
										className="w-full bg-slate-50 border border-slate-300 rounded-lg px-4 py-2 text-slate-900 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-center"
										maxLength={5}
									/>
								</div>
							</div>
							...
							<div>
								...
								<div className="flex">
									<span className="inline-flex items-center px-3 rounded-l-lg border border-r-0 border-slate-300 bg-slate-100 text-slate-500">
									...
									<input
										...
										className="flex-1 bg-slate-50 border border-slate-300 rounded-r-lg px-4 py-2 text-slate-900 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 font-mono text-sm"
							...
							{editingRoute ? (
								<div>
									...
									<div className="flex items-center space-x-2">
										<code className="flex-1 bg-slate-100 border border-slate-200 rounded-lg px-4 py-2.5 text-slate-900 font-mono text-sm break-all select-all">
								...
								<div>
									...
									<div className="w-full bg-slate-50 border border-indigo-200/50 rounded-lg px-4 py-2.5 text-slate-500 text-sm italic flex items-center">
							...
							<div className="flex justify-end space-x-3 pt-6 border-t border-slate-200 mt-6">
								<button
									...
									className="px-4 py-2 text-sm font-medium text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors border border-slate-300">
									Cancel
								</button>
								<button
									type="submit"
