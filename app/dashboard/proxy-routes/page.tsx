					...
					<table className="w-full text-left border-collapse">
						<thead>
							<tr className="bg-slate-800/50 border-b border-slate-800 text-xs uppercase tracking-wider text-slate-400">
								...
								<th className="px-6 py-4 font-medium">Path Prefix (ZTA)</th>
							...
							{routes.length === 0 ? (
								...
								routes.map((route) => (
									<tr
										...
										<td className="px-6 py-4">
											<span className="inline-flex items-center px-2 py-1 bg-slate-800 border border-slate-700 rounded text-sm text-slate-300 font-mono">
												{route.pathPrefix}
											</span>
										</td>
										...
										<td className="px-6 py-4 text-right">
											<button
												...
												className="p-2 bg-slate-800 text-slate-300 hover:text-indigo-400 hover:bg-indigo-500/10 rounded-lg transition-colors mr-2"
												title="Edit Route">
												<Edit2 className="w-4 h-4" />
											</button>
											<button
												onClick={() => handleDelete(route.id, route.name)}
												className="p-2 bg-slate-800 text-slate-300 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-colors"
												title="Delete Route">
						...
						<form onSubmit={handleSubmit} className="p-6 space-y-4">
							...
							<div>
								...
								<input
									...
									className="w-full bg-slate-950 border border-slate-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
							...
							<div>
								...
								<input
									...
									className="w-full bg-slate-950 border border-slate-700 rounded-lg px-4 py-2 text-white placeholder-slate-600 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
							...
							<div className="grid grid-cols-2 gap-4">
								<div>
									...
									<input
										...
										className="w-full bg-slate-950 border border-slate-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 font-mono text-sm"
										placeholder="/hr-app"
									/>
									<p className="text-xs text-slate-500 mt-1">
										ZTA entry route (e.g. /hr-app)
									</p>
								</div>
								...
								<div>
									...
									<input
										...
										className="w-full bg-slate-950 border border-slate-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-center"
										maxLength={5}
									/>
								</div>
							</div>
							...
							<div>
								...
								<div className="flex">
									...
									<input
										...
										className="flex-1 bg-slate-950 border border-slate-700 rounded-r-lg px-4 py-2 text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 font-mono text-sm"
