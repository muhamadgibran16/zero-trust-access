...
export default function Home() {
	return (
		<div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-500/30">
			{/* Navbar */}
			<nav className="fixed w-full z-50 top-0 transition-all duration-300 backdrop-blur-md bg-white/80 border-b border-slate-200">
			...
			<section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
					<div className="inline-flex items-center px-4 py-2 rounded-full border border-blue-200 bg-blue-50 text-blue-600 text-sm font-semibold mb-8 animate-in fade-in-up duration-500">
						<span className="flex h-2 w-2 rounded-full bg-blue-500 mr-2 animate-pulse" />
						Introducing FortiGateX 1.0
					</div>
					...
					<div className="flex flex-col sm:flex-row items-center justify-center gap-4">
						...
						<Link
							href="/login"
							className="px-8 py-4 bg-white hover:bg-slate-50 text-slate-900 font-semibold rounded-xl border border-slate-200 shadow-sm transition-all hover:scale-105 flex items-center w-full sm:w-auto justify-center text-lg">
			...
			{/* Trust Badges */}
			{/*<section className="py-10 border-y border-slate-200 bg-white/60 backdrop-blur-sm">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
						<div className="flex items-center text-xl font-bold font-serif">
							<div className="w-8 h-8 rounded bg-slate-700 mr-2" /> ACME Corp
						</div>
						<div className="flex items-center text-xl font-bold font-mono">
							<div className="w-8 h-8 rounded-full bg-slate-700 mr-2" /> Globex
						</div>
						<div className="flex items-center text-xl font-bold italic">
							<div className="w-8 h-8 rotate-45 bg-slate-700 mr-2" /> Soylent
						</div>
						<div className="flex items-center text-xl font-bold tracking-tighter">
							<div className="w-6 h-8 bg-slate-700 mr-2" /> Initech
						</div>
					</div>
				</div>
			</section>*/}
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						{[
							...
							<div
								key={i}
								className="group p-8 rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
		...
		<section className="py-24 bg-blue-50 relative overflow-hidden">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-10">
						<div className="flex flex-col items-center text-center bg-white rounded-2xl p-8 shadow-sm border border-blue-100">
						...
						<div className="flex flex-col items-center text-center bg-white rounded-2xl p-8 shadow-sm border border-blue-100">
							...
							<h3 className="text-2xl font-bold text-slate-900 mb-3">Lightning Fast Setup</h3>
							<p className="text-slate-600">
			...
			<footer className="bg-slate-100 text-slate-500 py-12 border-t border-slate-200">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
					<div className="flex items-center space-x-3 mb-6 md:mb-0">
						...
						/>
						<span className="font-bold text-xl text-slate-700">FortiGateX</span>
					</div>
