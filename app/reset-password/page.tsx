		...
		<>
			...
			{success ? (
				<div className="space-y-4 text-center">
					<div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 px-4 py-4 rounded-lg text-sm">
						✅ Your password has been reset successfully!
					</div>
					<Link
						href="/login"
						className="inline-flex items-center bg-violet-600 hover:bg-violet-500 text-white font-medium px-6 py-3 rounded-lg transition-colors">
